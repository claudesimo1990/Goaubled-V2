            ...
            <section class="left">
                ...
                <div class="contact-list">
                    ...
                    <div class="contact" id="5">
                        ...
                        <div class="contact-preview">
                            <div class="contact-text">
                                ...
                                <p class="font-preview">
                                    Ich schätze so um 7 Uhr, aber melde mich
                                    noch!
                                </p>
                            </div>
                        </div>
                        <div class="contact-time"><p>17:44</p></div>
                    </div>
                    <div class="contact" id="4">
                        ...
                        <div class="contact-time"><p>17:41</p></div>
                    </div>
                    ...
                    <div class="contact" id="2">
                        <img
                            src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/1089577/contact3.jpg"
                            alt="profilpicture"
                        />
                        <div class="contact-preview">
                            <div class="contact-text">
                        ...
                        <div class="contact-time"><p>17:31</p></div>
                    </div>
                    <div class="contact" id="1">
                        <img
                            src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/1089577/contact2.JPG"
                            alt="profilpicture"
                        />
                        <div class="contact-preview">
                            <div class="contact-text">
                        ...
                        <div class="contact-time"><p>17:21</p></div>
                    </div>
                    <div class="contact" id="0">
                        ...
                        <div class="contact-preview">
                            <div class="contact-text">
                                ...
                                <p class="font-preview">
                                    Jap, ich bin um circa 15:00 auf der
                                    Landstraße :)
                                </p>
                            </div>
                        </div>
                        <div class="contact-time"><p>16:50</p></div>
                    </div>
                </div>
            </section>
