...
@import "./../../../sass/_variables.scss";
    ...
    .process-step{
        ...
        box-shadow: -6px 8px 0px 0px $quigo;
    }
    .process-point-right{
        background: #ffffff;
        width: 25px;
    ...
    .process-step:after{
        content: "";
        border-top: 8px solid $quigo;
        border-bottom: 8px solid $quigo;
        border-left: 8px solid $quigo;
        border-right: 8px solid $quigo;
        display: inline-grid;
        position: absolute;
        left: -16px;
        top: 0;
