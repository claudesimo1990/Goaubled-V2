                            ...
                            <div class="row">
                                    ...
                                    <div class="carousel-caption bg-white">
                                        <div class="row">
                                            <div class="col-sm-3 col-4 align-items-start">
                                                <img width="200" :src="users[4].avatar_original ? users[4].avatar_original : asset +'/UsersAvatars/'+ users[4].avatar" :alt="users[4].name">
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="carousel-caption bg-white">
                                        <div class="row">
                                            <div class="col-sm-3 col-4 align-items-start">
                                                <img width="200" :src="users[1].avatar_original ? users[1].avatar_original : asset +'/UsersAvatars/'+ users[1].avatar" :alt="users[1].name">
                                            </div>
                                            <div class="col-sm-9 col-8">
                                                <h2>{{ users[1].name }}</h2>
                                                <p>Well incremented. Comes with recommended workout. I'm using it to help with bladder leakage issues that I've been experiencing since a recent vasectomy.</p>
                            ...
                            <div class="bg"></div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="carousel-caption bg-white">
                                        <div class="row">
                                            <div class="col-sm-3 col-4 align-items-start">
                                                <img :src="users[2].avatar_original ? users[2].avatar_original : asset +'/UsersAvatars/'+ users[2].avatar" :alt="users[2].name">
                                            </div>
                                            <div class="col-sm-9 col-8">
                                            <h2>{{ users[2].name }}</h2>
                                                <p>Well incremented. Comes with recommended workout. I'm using it to help with bladder leakage issues that I've been experiencing since a recent vasectomy.</p>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="carousel-caption bg-white">
                                        <div class="row">
                                            <div class="col-sm-3 col-4 align-items-start">
                                                <img width="200" :src="users[3].avatar_original ? users[3].avatar_original : asset +'/UsersAvatars/'+ users[3].avatar" :alt="users[3].name">
                                            </div>
                                            <div class="col-sm-9 col-8">
                                            <h2>{{ users[3].name }}</h2>
                                                <p>Well incremented. Comes with recommended workout. I'm using it to help with bladder leakage issues that I've been experiencing since a recent vasectomy.</p>
