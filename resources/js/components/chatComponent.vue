                ...
                <div class="chatbox__body">
                    <div class="chatbox__body__message chatbox__body__message--left">
                        ...
                        <div class="chatbox_timing">
                            <ul>
                                <li><a href="#"><i class="fab fa-calendar"></i> 22/11/2018</a></li>
                        ...
                        <div class="ul_section_full">
                            <ul class="ul_msg">
                                ...
                                <li>Lorem ipsum dolor sit amet, consectetur adipiscing elit.tt </li>
                            </ul>
                            <div class="clearfix"></div>
                            <ul class="ul_msg2">
                ...
                <div class="panel-footer">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button class="btn bt_bg btn-recherche text-white" id="btn-chat">
                                envoyer</button>
                        </span>
                    </div>
                </div>
